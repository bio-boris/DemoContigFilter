...
from bsadkhin-Contigfilter.bsadkhin-ContigfilterImpl import bsadkhin-Contigfilter
from bsadkhin-Contigfilter.bsadkhin-ContigfilterServer import MethodContext
from bsadkhin-Contigfilter.authclient import KBaseAuth as _KBaseAuth

from installed_clients.AssemblyUtilClient import AssemblyUtil
from installed_clients.WorkspaceClient import Workspace


class bsadkhin-ContigfilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('bsadkhin-Contigfilter'):
        ...
        cls.serviceImpl = bsadkhin-Contigfilter(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_bsadkhin-Contigfilter_" + str(suffix)
